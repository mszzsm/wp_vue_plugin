			...
			<div class="content">
                ...
                <article>
					<div class="grid-container">
						<div v-for="post in filteredPosts" class="post grid-item" >
                            ...
                            <a v-bind:href="post.link"><img class="grayimg" src="https://picsum.photos/id/18/600/300" alt="img"></a>
						</div>
					</div>
				</article>
            </div>
		...
		computed: {
            filteredPosts() {
                ...
                if (active == "") { 
					...
					var id = this.posts.filter((Post) => Post.categories == postId);
                    return id;
                }
			},
